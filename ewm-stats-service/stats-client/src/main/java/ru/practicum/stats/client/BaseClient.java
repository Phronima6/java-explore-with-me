...
public class BaseClient {
    ...
    protected ResponseEntity<Object> get(final String path, @Nullable final Map<String, Object> parameters) {
    ...
    private <T> ResponseEntity<Object> makeRequest(final HttpMethod method, final String path,
